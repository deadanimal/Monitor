...
Route::get('afeezaziz', [PenggunaController::class, 'afeezaziz']);
Route::post('afeezaziz', [PenggunaController::class, 'send_afeezaziz']);

Route::get('myjpj', [PenggunaController::class, 'myjpj']);
Route::get('vrar', [PenggunaController::class, 'vrar']);
Route::get('web3', [PenggunaController::class, 'web3']);
Route::get('chatbot', [PenggunaController::class, 'chatbot']);

Route::post('usecase', [PenggunaController::class, 'send_usecase']);

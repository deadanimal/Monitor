...
<main class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="header">
            ...
            <p class="header-subtitle">{{$ruj->kategori}}</p>
        </div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                ...
                <div class="card-body" onload="scriptRan()">
                    ...
                    <form action="/rujukan/{{$ruj->id}}" method="POST">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label class="form-label">Nama</label>
                            <input class="form-control" type="text" name="nama" value="{{$ruj->nama}}">
                        </div>
                            ...
                            <div class="col">
                                <div class="textwrapper">
                                    <textarea id="markdown-input" name="deskripsi" class="form-control mb-3" cols="2"
                                        ...
                                        style="width:100%;">{{$ruj->deskripsi}}</textarea>
                                </div>
                            </div>
                        </div>

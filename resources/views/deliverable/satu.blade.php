                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <label>Nama</label>
                                                                <input type="text" class="form-control" id="nama" name="nama" value="{{$deli->nama}}" placeholder="Nama Hasil">
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                <label>Kategori</label>
                                                                <select class="form-control mb-3" id="kategori" name="kategori">
                                                                        <option value="ANALISA" {{ $deli->kategori == 'ANALISA' ? 'selected' : '' }}>Analisa</option>
                                                                        <option value="PEMBANGUNAN" {{ $deli->kategori == 'PEMBANGUNAN' ? 'selected' : '' }}>Pembangunan</option>
                                                                        <option value="PENGUJIAN" {{ $deli->kategori == 'PENGUJIAN' ? 'selected' : '' }}>Pengujian</option>
                                                                        <option value="LATIHAN" {{ $deli->kategori == 'LATIHAN' ? 'selected' : '' }}>Latihan</option>
                                                                        <option value="PENTADBIRAN" {{ $deli->kategori == 'PENTADBIRAN' ? 'selected' : '' }}>Pentadbiran</option>
                                                                        <option value="LAIN" {{ $deli->kategori == 'LAIN' ? 'selected' : '' }}>Lain-lain</option>
                                                                </select>                                                       
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                <label>Tarikh</label>
                                                                ...
                                                                <input type="date" class="form-control" id="tarikh_rancang" name="tarikh_rancang" value="{{$deli->tarikh_rancang}}">
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                ...
                                                                <select class="form-control mb-3" id="pekerja_id" name="pekerja_id">
                                                                        ...
                                                                        <option value="{{ $piper->id }}" {{ $deli->pekerja_id == $piper->id ? 'selected' : '' }}>{{ $piper->roles[0]->display_name }} - {{ $piper->name }} </option>
                                                                        @endforeach   
                                                                        @foreach ($umpa_remotes as $umpa_remote)
                                                                        <option value="{{ $umpa_remote->id }}" {{ $deli->pekerja_id == $umpa_remote->id ? 'selected' : '' }}>{{ $umpa_remote->roles[0]->display_name }} -  {{ $umpa_remote->name }} </option>
                                                                        @endforeach                                                           
                                                                </select>                                                       
                                                                </div>   
                                                                ...
                                                                <select class="form-control mb-3" id="pemeriksa_id" name="pemeriksa_id">
                                                                        @foreach ($pipers as $piper)
                                                                        <option value="{{ $piper->id }}" {{ $deli->pemeriksa_id == $piper->id ? 'selected' : '' }}>{{ $piper->roles[0]->display_name }} - {{ $piper->name }} </option>
                                                                        @endforeach                                                            
                                                                </select>                                                       
                                                                </div> 
                                                                ...
                                                                <select class="form-control mb-3" id="pengesah_id" name="pengesah_id">
                                                                        @foreach ($pipers as $piper)
                                                                        <option value="{{ $piper->id }}" {{ $deli->pengesah_id == $piper->id ? 'selected' : '' }}>{{ $piper->roles[0]->display_name }} - {{ $piper->name }} </option>
                                                                        @endforeach                                                          
                                                                </select>                                                       
                                                                </div>                                                 
                                                                ...
                                                                <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Deksripsi untuk Hasil" rows="3">{{$deli->deskripsi}}</textarea>
                                                                </div>                                                   

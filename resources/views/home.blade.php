                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="navbar-social d-none d-sm-flex align-items-center">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://www.instagram.com/pipeline.my/?hl=en"><i class="lni-instagram-original"></i></a></li>
                                    <li><a href="https://www.linkedin.com/company/pipeline-network"><i class="lni-linkedin-original"></i></a></li>                                  
                                </ul>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                    ...
                    <div class="contact-form">
                        <form id="contact-form" action="/" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form form-group">
                                        <textarea placeholder="Your Mesaage" name="message" data-error="Please leave a message." required="required"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p class="text">&copy; 2023 Pipeline Network Sdn. Bhd.</p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->

                                ...
                                <div class="card">
                                                        ...
                                                        <div class="row">
                                                                <div class="mb-3 col-md-6">
                                                                    <label>Nama</label>
                                                                    <input type="text" class="form-control" id="nama" name="nama" value="{{$invoice->nama}}" placeholder="Nama Invoice">
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                ...
                                                                <!-- <div class="input-group date" id="datetimepicker-date" data-target-input="nearest">
                                                                    ...
                                                                    <input type="date" class="form-control" id="tarikh_rancang" name="tarikh_rancang" value="{{$invoice->tarikh_rancang}}">
                                                                </div> 
